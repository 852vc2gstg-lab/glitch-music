...
contextBridge.exposeInMainWorld('novaPlayer', {
  ...
  connectSpotifyAccount: () => ipcRenderer.invoke('spotify:connect'),
  ...
  fetchLyricsFromLrcLib: (payload) => ipcRenderer.invoke('lyrics:fetch-lrclib', payload),
  fetchLyricsAggregate: (payload) => ipcRenderer.invoke('lyrics:fetch-aggregate', payload),
